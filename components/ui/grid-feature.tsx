...
import HoverTranslateTwo from "./iteractive-card";
    ...
    <section className="max-w-7xl mx-auto p-4 bg-white" ref={featuresRef}>
      ...
      <div className="grid grid-cols-12 gap-4">
        ...
        <TimelineAnimation
          ...
          timelineRef={featuresRef}
          customVariants={revealVariants}
          className="lg:col-span-4 sm:col-span-6 col-span-12 border rounded-lg p-4 border-neutral-200 group"
        >
          <motion.h1
          ...
          <div className="flex w-full max-w-md flex-col overflow-hidden rounded-xl bg-white shadow-lg">
            ...
            <div className="flex-1 space-y-4 p-4 overflow-hidden">
              ...
              >
                ...
                transactions.
                <motion.button
                  className="absolute -bottom-2 right-0 flex items-center gap-1 rounded-full bg-orange-500 px-2 py-1 text-xs text-white shadow-xs hover:bg-orange-600 focus:outline-hidden focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
                  initial={{ scale: 0, rotate: 180 }}
                  animate={{ scale: 1, rotate: 0 }}
            ...
            >
              <motion.input
                ...
                className="flex-1 rounded-lg border border-gray-300 bg-gray-100 px-4 py-2 focus:outline-hidden focus:ring-2 focus:ring-purple-500"
                initial={{ width: "60%" }}
                animate={{ width: "100%" }}
                transition={{ delay: 5.0, duration: 0.6 }}
              />
              <motion.button
                className="flex h-10 w-10 items-center justify-center rounded-lg bg-purple-600 text-white hover:bg-purple-700 focus:outline-hidden focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                initial={{ scale: 0, rotate: 180 }}
                animate={{ scale: 1, rotate: 0 }}
