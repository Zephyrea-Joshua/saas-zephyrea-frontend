  ...
  return (
    <>
      ...
      >
                ...
                <div className="w-full">
                  <div className="flex items-center gap-3 w-full justify-between pr-2 pl-1">
                    <div className="flex items-center gap-2">
                      <img
                        src={`https://pro-section.ui-layouts.com/${card.logo}`}
                        alt={card.name}
                        width={20}
                        height={20}
                      />
        ...
        <div
          className="pointer-events-none absolute -top-12 left-0 w-full pt-[100px] pb-[80px] bg-linear-to-b from-white to-transparent z-20"
